    ...
    <div className="flex h-screen">
      ...
      <div className="hidden lg:flex items-center justify-center flex-1 bg-white">
        <div className="max-w-md text-center">
          ...
          >
            {/* SVG content is omitted for brevity; you can reuse the original SVG if needed */}
            <path
              ...
              fill="#3f3d56"
            />
            {/* Add the rest of the SVG paths if you want the illustration */}
          </svg>
        </div>
      </div>
      ...
      <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
        <div className="max-w-md w-full p-6">
          ...
          <div className="mt-4 flex flex-col lg:flex-row items-center justify-between gap-2">
            <button
              type="button"
              className="w-full lg:w-1/2 flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md border border-gray-200 hover:bg-gray-50 transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
          ...
          <form className="space-y-4 mt-4">
            <div>
              ...
              <input
                ...
                id="username"
                name="username"
                className="mt-1 p-2 w-full border rounded-md focus:outline-none focus:ring-2 focus:ring-gray-300 transition-colors"
              />
            </div>
            <div>
              <label
